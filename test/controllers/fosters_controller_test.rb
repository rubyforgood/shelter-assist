...
class FostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create foster" do
    assert_difference("Foster.count") do
      post fosters_url, params: { foster: { email: "hi@hi.com", phone: '5714128473', street: 'Yo', apt: 'unit A' } }
    end
  ...
  test "should update foster" do
    patch foster_url(@foster), params: { foster: { email: "hi@hi.com", phone: '5714128473', street: 'Yo', apt: 'unit A' } }
